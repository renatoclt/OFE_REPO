...
builder = (function () {
	...
	//var btnDownload = $('#btn_download');
  	var test = function(){
		  console.log('alex es un chucha');
	  }
	var init = function(object, size, orientation, plantilla) {
	...
	var parseXML = function(plantilla) {
		/*
		 ...
		 */
		var decodedFile = new Buffer(plantilla, 'base64');
		//var xml = xmlBuilder.create(decodedFile);
		//console.log(xml);
		// xmlReader.readXML(decodedFile, function(err, data) {
		// 	if (err) {
		// 	  console.error(err);
		// 	}
		...
		//   });
		//var json = parser.toJson(decodedFile);
...
exports.init = builder.init;
exports.load = builder.load;
